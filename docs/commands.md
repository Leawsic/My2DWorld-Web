...
| 参数 | 说明 |
| --- | --- |
| `creative` | 创造模式：可飞行、放置/破坏方块、攻击生物、掉入虚空会扣血并重生 |
...
| `x`、`y` | 可选坐标；缺省时生成在玩家面前 1.5 格处 |
| `数量` | 可选，`1`~`64`，默认 `1`；多个生物沿水平方向排成一排生成 |
...
示例：`/summon cow_temperate_baby`、`/summon zombie 100 64 10`
